...
$StdOutLog = Join-Path $LogsDir "jarvis_local_n8n_gateway_hardened_v2_stdout.log"
$StdErrLog = Join-Path $LogsDir "jarvis_local_n8n_gateway_hardened_v2_stderr.log"
...
& '$PyExe' -X utf8 -m uvicorn app.jarvis_local_n8n_gateway_hardened_v2:app --host $HostName --port $Port
"@
