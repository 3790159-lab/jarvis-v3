...
Write-Host "== Block 2.5 compile ==" -ForegroundColor Cyan

$Targets = @(
    "app\services\tool_router.py",
    "app\services\tool_chain_planner.py",
    "app\services\tool_chain_executor.py",
    "app\routers\tool_chains.py",
...
$ImportScript = Join-Path $ProjectRoot "jarvis_block25_import_check.py"
$PyLines = @(
    'import importlib',
    'importlib.import_module("app.services.tool_router")',
    'importlib.import_module("app.services.tool_chain_planner")',
    'importlib.import_module("app.services.tool_chain_executor")',
    'importlib.import_module("app.routers.tool_chains")',
...
Write-Host "Block 2.5 compile/import checks passed." -ForegroundColor Green