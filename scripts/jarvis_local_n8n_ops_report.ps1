...
$Version   = Safe-Json "$GatewayBaseUrl/api/jarvis/n8n/version"
$StatusAll = Safe-Json "$GatewayBaseUrl/api/jarvis/n8n/status/all?limit=20"
$Routes    = Safe-Json "$GatewayBaseUrl/api/jarvis/n8n/_routes"
$Summary   = Safe-Json "$GatewayBaseUrl/api/jarvis/n8n/workflows/summary?limit=20"
...
$JsonPath = Join-Path $OutDir "jarvis_local_n8n_ops_report_$Stamp.json"
$TxtPath  = Join-Path $OutDir "jarvis_local_n8n_ops_logs_$Stamp.txt"
