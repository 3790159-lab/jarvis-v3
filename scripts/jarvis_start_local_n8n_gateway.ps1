...
$StdOutLog = Join-Path $LogsDir "jarvis_local_n8n_gateway_stdout.log"
$StdErrLog = Join-Path $LogsDir "jarvis_local_n8n_gateway_stderr.log"
...
& '$PyExe' -X utf8 -m uvicorn app.jarvis_local_n8n_gateway:app --host $HostName --port $Port
"@
