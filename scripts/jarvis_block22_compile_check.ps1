...
Write-Host "== Block 2.2 compile ==" -ForegroundColor Cyan

$Targets = @(
 "app\services\tool_safety.py",
 "app\services\tool_retry_executor.py",
...
$ImportScript = Join-Path $ProjectRoot "jarvis_block22_import_check.py"
$PyLines = @(
 'import importlib',
 'importlib.import_module("app.services.tool_safety")',
 'importlib.import_module("app.services.tool_retry_executor")',
...
Write-Host "Block 2.2 compile/import checks passed." -ForegroundColor Green