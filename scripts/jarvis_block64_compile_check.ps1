...
Write-Host "== Block 6.4 compile check ==" -ForegroundColor Cyan
...
$ImportScript = Join-Path $ProjectRoot "jarvis_block64_import_check.py"
$PyLines = @(
  'import importlib' ,
  'importlib.import_module("app.main")' ,
  'importlib.import_module("app.routers.multistep")' ,
  'importlib.import_module("app.routers.resume_recovery")' ,
  'importlib.import_module("app.services.mission_resume_store")' ,
  'print("IMPORT_OK")'
)
...
Write-Host "Block 6.4 compile/import checks passed." -ForegroundColor Green
