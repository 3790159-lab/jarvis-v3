...
- Run ID: `evidence_20260427_040459`
- Created: `2026-04-27T04:04:59`
...
- ❌ `http://127.0.0.1:8015/` status=`404` elapsed_ms=`67`
- ✅ `http://127.0.0.1:8015/health` status=`200` elapsed_ms=`14`
...
- ✅ `http://127.0.0.1:8015/api/provider-routing/health` status=`200` elapsed_ms=`18`
