...
- Run ID: `evidence_20260427_041054`
- Created: `2026-04-27T04:10:54`
...
- ✅ `http://127.0.0.1:8015/api/ai/health` status=`200` elapsed_ms=`9`
- ✅ `http://127.0.0.1:8015/api/autonomy/health` status=`200` elapsed_ms=`7`
