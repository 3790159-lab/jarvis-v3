...
- Run ID: `evidence_20260427_035724`
- Created: `2026-04-27T03:57:24`
...
- ✅ `http://127.0.0.1:8015/health` status=`200` elapsed_ms=`1`
- ✅ `http://127.0.0.1:8015/api/ai/health` status=`200` elapsed_ms=`19`
...
- ✅ `http://127.0.0.1:8015/api/provider-routing/health` status=`200` elapsed_ms=`17`
