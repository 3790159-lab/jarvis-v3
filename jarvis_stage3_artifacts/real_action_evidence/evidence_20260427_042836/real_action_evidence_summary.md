...
- Run ID: `evidence_20260427_042836`
- Created: `2026-04-27T04:28:36`
...
- ✅ `http://127.0.0.1:8015/api/autonomy/health` status=`200` elapsed_ms=`34`
- ✅ `http://127.0.0.1:8015/api/autonomy/mission-bridge/health` status=`200` elapsed_ms=`15`
- ✅ `http://127.0.0.1:8015/api/provider-routing/health` status=`200` elapsed_ms=`31`
