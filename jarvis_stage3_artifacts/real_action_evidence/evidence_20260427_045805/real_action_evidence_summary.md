...
- Run ID: `evidence_20260427_045805`
- Created: `2026-04-27T04:58:05`
...
- ❌ `http://127.0.0.1:8015/` status=`404` elapsed_ms=`61`
- ✅ `http://127.0.0.1:8015/health` status=`200` elapsed_ms=`17`
- ✅ `http://127.0.0.1:8015/api/ai/health` status=`200` elapsed_ms=`14`
- ✅ `http://127.0.0.1:8015/api/autonomy/health` status=`200` elapsed_ms=`5`
- ✅ `http://127.0.0.1:8015/api/autonomy/mission-bridge/health` status=`200` elapsed_ms=`29`
- ✅ `http://127.0.0.1:8015/api/provider-routing/health` status=`200` elapsed_ms=`23`
