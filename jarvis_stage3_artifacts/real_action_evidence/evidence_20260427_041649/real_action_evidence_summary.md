...
- Run ID: `evidence_20260427_041649`
- Created: `2026-04-27T04:16:49`
...
- ❌ `http://127.0.0.1:8015/` status=`404` elapsed_ms=`60`
- ✅ `http://127.0.0.1:8015/health` status=`200` elapsed_ms=`3`
- ✅ `http://127.0.0.1:8015/api/ai/health` status=`200` elapsed_ms=`1`
- ✅ `http://127.0.0.1:8015/api/autonomy/health` status=`200` elapsed_ms=`20`
- ✅ `http://127.0.0.1:8015/api/autonomy/mission-bridge/health` status=`200` elapsed_ms=`6`
