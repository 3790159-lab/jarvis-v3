...
- Run ID: `evidence_20260427_040246`
- Created: `2026-04-27T04:02:46`
...
- ❌ `http://127.0.0.1:8015/` status=`404` elapsed_ms=`72`
- ✅ `http://127.0.0.1:8015/health` status=`200` elapsed_ms=`17`
- ✅ `http://127.0.0.1:8015/api/ai/health` status=`200` elapsed_ms=`13`
- ✅ `http://127.0.0.1:8015/api/autonomy/health` status=`200` elapsed_ms=`18`
- ✅ `http://127.0.0.1:8015/api/autonomy/mission-bridge/health` status=`200` elapsed_ms=`25`
