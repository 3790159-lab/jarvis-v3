...
- Run ID: `evidence_20260427_041847`
- Created: `2026-04-27T04:18:47`
...
- ✅ `http://127.0.0.1:8015/api/autonomy/health` status=`200` elapsed_ms=`26`
- ✅ `http://127.0.0.1:8015/api/autonomy/mission-bridge/health` status=`200` elapsed_ms=`2`
- ✅ `http://127.0.0.1:8015/api/provider-routing/health` status=`200` elapsed_ms=`28`
