...
- Run ID: `evidence_20260427_044816`
- Created: `2026-04-27T04:48:16`
...
- ❌ `http://127.0.0.1:8015/` status=`404` elapsed_ms=`82`
- ✅ `http://127.0.0.1:8015/health` status=`200` elapsed_ms=`7`
- ✅ `http://127.0.0.1:8015/api/ai/health` status=`200` elapsed_ms=`6`
- ✅ `http://127.0.0.1:8015/api/autonomy/health` status=`200` elapsed_ms=`4`
- ✅ `http://127.0.0.1:8015/api/autonomy/mission-bridge/health` status=`200` elapsed_ms=`28`
