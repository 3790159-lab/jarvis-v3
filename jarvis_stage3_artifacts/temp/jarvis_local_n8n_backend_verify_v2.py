...
OUT_PATH = OUT_DIR / f"jarvis_local_n8n_backend_verify_v2_{STAMP}.json"
...
smoke = req(
    ...
    {
        "name": f"jarvis-supervisor-smoke-{STAMP}",
        "webhook_path": f"jarvis-supervisor-smoke-{STAMP}",
    },
)
