...
#
# 20.08 первая фраза переписана ПО СЛОВУ ВЛАДЕЛЬЦА (вариант Б спеки
# 2026-08-20-panel-client-name): «Вона … її назад» согласовано по роду с
# женской персоной, то есть было таким же зашитым допущением, как и имя
# «Ольга» рядом. Прежняя редакция стояла с 12.08 и этот сторож не дал
# переписать её молча — он и сработал, когда правка пришла.
APPROVED_1 = ("Бот перестане відповідати <b>ВСІМ</b> лідам, доки ви не "
              "увімкнете його назад.")
