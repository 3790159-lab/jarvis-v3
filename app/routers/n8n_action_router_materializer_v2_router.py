...
from app.services.n8n_action_router_materializer_v2 import N8NActionRouterMaterializerV2

router = APIRouter(prefix="/api/n8n/materializer-v2", tags=["n8n-materializer-v2"])
_service = N8NActionRouterMaterializerV2()
