...
from app.services.ultra_upgrade_engine import (
    build_full_creator_package,
    build_ultra_upgrade_plan,
)
from app.services.claude_ecosystem_execution_bridge import (
    run_safe_night_preflight,
    run_safe_night_postflight,
)
...
def ecosystem_health() -> Dict[str, Any]:
    ...
    return {
        ...
        "schema": "jarvis.claude_ecosystem.router.v1_3",
...
@router.post("/ultra/plan")
def ecosystem_ultra_plan(payload: Dict[str, Any] | None = None) -> Dict[str, Any]:
    return build_ultra_upgrade_plan(payload or {})


@router.post("/full-creator/package")
def ecosystem_full_creator_package(payload: Dict[str, Any] | None = None) -> Dict[str, Any]:
    return build_full_creator_package(payload or {})


@router.post("/safe-night/preflight")
def ecosystem_safe_night_preflight(payload: Dict[str, Any] | None = None) -> Dict[str, Any]:
    return run_safe_night_preflight(payload or {})


@router.post("/safe-night/postflight")
def ecosystem_safe_night_postflight(payload: Dict[str, Any] | None = None) -> Dict[str, Any]:
    return run_safe_night_postflight(payload or {})