    ...
    *,
    ...
    tools: List[Tool] = [
        _make_dispatch_tool(
            ...
            description=(
                "Начать сбор исходных фото (лиц-источников) для пакетного "
                "face-swap. Эквивалент /swapbatch_source."
            ),
            command="source",
        ...
        _make_dispatch_tool(
            ...
            description=(
                "Начать приём целевых фото, в которые подставляются лица. "
        ...
        _make_dispatch_tool(
            ...
            description="Запустить пакетный face-swap. Эквивалент /swapbatch_go.",
            command="go",
            dispatch_fn=dispatch_fn,
        ...
        _make_dispatch_tool(
            ...
            description=(
                "Отменить текущий пакет face-swap. Эквивалент /swapbatch_cancel."
            ),
            command="cancel",
            dispatch_fn=dispatch_fn,
    ...
    tools.append(
        Tool(
            ...
            description=(
                "Анимировать результаты swap в видео. mode='yes' — дефолтное "
                "движение, 'custom' — кастомное, 'no' — без анимации. "
    ...
    tools.append(
        Tool(
            ...
            description=(
                "Задать качество анимации (длительность в секундах и FPS). "
