...
def _share_window(groups: list[list[dict]], budget: int) -> list[dict]:
    ...
    ЗАЧЕМ ТОГДА КВОТА. Она держит гарантию «видно ОБА источника» независимо от
    того, какой из них сейчас свежее, — а свежее бывает то один, то другой: на
    живых источниках 14.08 всё было наоборот (свежайшее control_events — 13.08,
    свежайшая строка гардиана — 14.08, клиент старше на ~22 часа, и за срез
    уезжал КЛИЕНТ: 5 строк из 20 на экране). Без квоты всплеск в любом из двух
    источников прячет второй целиком, и какой именно спрячется — вопрос
